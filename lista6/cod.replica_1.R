...
# O c√≥digo usado no texto publicado na 'Pol√≠tica Hoje' segue abaixo. O c√≥digo 
# completo que nos permitiu gerar os resultados apresentados no texto est√£o em 
# outro arquivo chamado 'simulacao'. Para replicar nosso estudo ser√° preciso 
# fazer o download do banco de dados criado para este estudo. Voc√™ encontra o 
# link para o banco e para os outros arquivos em http://dvn.iq.harvard.edu/dvn/dv/felipenunes. 
# Depois de fazer o donwload dos dados, voc√™ precisa modificar o endere√ßo nas 
# duas linhas de comando abaixo. Entre as aspas e antes da barra invertida √© 
# preciso colocar o endere√ßo do seu computador onde os arquivos foram salvos. 
# S√≥ assim o comando abaixo funcionar√° corretamente.
...
# Nesta seÁ„o disponibilizaremos os cÛdigos necess·rios para gerar testes e gr·ficos 
# que nos possibilitam visualmente avaliar a manutenÁ„o ou quebra dos pressupostos 
# que o modelo linear de mÌnimos quadrados ordin·rios requer.
# Os gr·ficos foram gerados duas vezes: na primeira, os dados n„o apresentam problemas 
# para a utilizaÁao do modelo linear; na segunda, problemas s„o artificialmente 
# produzidos afim de mostrar como os gr·ficos e os testes s„o influenciados pelos mesmos.
